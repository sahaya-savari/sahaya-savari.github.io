    ...
    return (
        <div className={styles.shareSection}>
            ...
            <div className={styles.shareButtons}>
                <button onClick={shareTwitter} className={styles.shareBtn} aria-label="Share on Twitter/X" title="Share on X">
                ...
                <button onClick={copyLink} className={`${styles.shareBtn} ${copied ? styles.copied : ''}`} aria-label="Copy link" title="Copy link">
